import 'package:flutter/material.dart';
 ...
 class Styles{
  ...
  static TextStyle headlineStyle5 = TextStyle(fontSize: 12,color: Colors.grey.shade500,fontWeight: FontWeight.w300);
  static TextStyle headlineStylen = TextStyle(fontSize: 14,color: textColor,fontWeight: FontWeight.w500);
 }